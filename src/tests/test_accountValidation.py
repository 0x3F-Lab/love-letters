...
class TestAccountValidation():
  ...
  def test_accountValidation(self):
    ...
    self.driver.find_element(By.CSS_SELECTOR, ".btn:nth-child(13)").click()
    assert self.driver.find_element(By.CSS_SELECTOR, ".form-group:nth-child(3) > .error-message").text == "First Name should contain only alphabetic characters."
    assert self.driver.find_element(By.CSS_SELECTOR, ".form-group:nth-child(4) > .error-message").text == "Last Name should contain only alphabetic characters."
    assert self.driver.find_element(By.CSS_SELECTOR, ".form-group:nth-child(6) > .error-message").text == "Invalid email format."
    assert self.driver.find_element(By.CSS_SELECTOR, ".form-group:nth-child(7) > .error-message").text == "Password must be at least 8 characters long."
    assert self.driver.find_element(By.CSS_SELECTOR, ".error-message:nth-child(13)").text == "At least one social media handle must be provided"
    self.driver.find_element(By.ID, "first_name").click()
    ...
    assert self.driver.find_element(By.CSS_SELECTOR, ".error-message").text == "Password must contain at least one uppercase letter."
    self.driver.find_element(By.ID, "password").click()
    self.driver.find_element(By.ID, "password").send_keys("1aaaaaaA")
    self.driver.find_element(By.CSS_SELECTOR, ".btn:nth-child(13)").click()
    self.driver.find_element(By.ID, "password").click()
    self.driver.find_element(By.ID, "password").send_keys("1aaaaaaA!")
    self.driver.find_element(By.CSS_SELECTOR, ".btn:nth-child(13)").click()
    assert self.driver.find_element(By.CSS_SELECTOR, ".alert-success").text == "Account successfully created\\\\n×"
