...
class TestNotificationMake():
  ...
  def test_notificationMake(self):
    ...
    assert self.driver.find_element(By.CSS_SELECTOR, ".alert-success").text == "Connect request sent.\\\\n×"
    self.driver.find_element(By.CSS_SELECTOR, ".card:nth-child(10) form > .btn").click()
    assert self.driver.find_element(By.CSS_SELECTOR, ".alert-success").text == "Connect request sent.\\\\n×"
    ...
    assert self.driver.find_element(By.CSS_SELECTOR, ".alert-success").text == "Successfully logged in\\\\n×"
    assert self.driver.find_element(By.CSS_SELECTOR, ".col-md-3:nth-child(3) .card-title").text == "Responses3"
    self.driver.find_element(By.LINK_TEXT, "Notifications").click()
    assert self.driver.find_element(By.LINK_TEXT, "Selenium Test").text == "Selenium Test"
    self.driver.find_element(By.LINK_TEXT, "Log Out").click()
    assert self.driver.find_element(By.CSS_SELECTOR, ".alert-success").text == "You have been logged out.\\\\n×"
    self.driver.find_element(By.LINK_TEXT, "Log In").click()
    self.driver.find_element(By.ID, "login-email").click()
